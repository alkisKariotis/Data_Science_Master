# ----- ----- ----- Kafka Consumer 1 - Sending Blocks to MongoDB ----- ----- -----
...
# Configure Kafka Consumer for partition 1
consumer = KafkaConsumer(
    'Blocks',                                       # Topic
    bootstrap_servers=['localhost:9092'],           # Kafka Bootstrap Servers
    auto_offset_reset='earliest',                   # Start Reading at the Earliest Message
    enable_auto_commit=True,                        # Automatically Commit Offsets
    group_id='block-consumer-group-1',              # Consumer Group ID
...
for message in consumer:
    ...
    if block_data['sequence_number'] % 2 != 0:      # Reads only Blocks from Partition 1 (Odd Sequence Number)
